...
# Build script for macOS x64 - supports both lite and full variants
...
if [ "$VARIANT" == "full" ]; then
    ...
    # Download SDK
    SDK_URL="https://builds.dotnet.microsoft.com/dotnet/Sdk/${DOTNET_VERSION}/dotnet-sdk-${DOTNET_VERSION}-osx-x64.tar.gz"
